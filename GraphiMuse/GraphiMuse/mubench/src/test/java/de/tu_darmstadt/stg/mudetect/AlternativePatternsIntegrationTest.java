...
public class AlternativePatternsIntegrationTest {
    ...
    @Test
    public void matchesSubtypes() throws IOException, InterruptedException {
        ...
        PAMDetect detector = new PAMDetect(() -> asSet(pattern),
    ...
    @Test
    public void multipleCallViolations() throws IOException, InterruptedException {
    ...
    @Test
    public void mappingToWrongDataNode() throws IOException, InterruptedException {
