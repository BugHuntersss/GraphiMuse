...
public class Pattern {
	...
	public HashMap<String , ArrayList<String>> abstractNodeListForThis = new HashMap<>();
	public HashMap<String , Integer> APIFrequency = new HashMap<>();
	...
	public HashMap<String , ArrayList<String>> getAbstractNodeListForThis(){return this.abstractNodeListForThis;}

	public void setAbstractNodeListForThis(HashMap<String, ArrayList<String>> map) {this.abstractNodeListForThis = map;}
