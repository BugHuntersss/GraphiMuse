...
public class Fragment {
	...
	private int idSum = 0;
	private Edge genEdge;
	private ArrayList<Node> new_add = new ArrayList<>();
...
//		}
	...
	public ArrayList<Node> getNew_add() {
		return new_add;
	}

	public void setNew_add(ArrayList<Node> new_add) {
