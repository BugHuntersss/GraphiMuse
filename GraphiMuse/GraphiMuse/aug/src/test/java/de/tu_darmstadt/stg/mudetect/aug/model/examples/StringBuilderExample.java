...
public class StringBuilderExample {
    ...
    public void aug() {
        APIUsageExample aug = buildAUG(new Location("aug",
                ...
                .withMethodCall("append1", "java.lang.AbstractStringBuilder", "append()", 12, new ArrayList<>())
                .withParameterEdge("str1", "append1")
                .withReceiverEdge("sb", "append1")
                .withLiteral("str2", "java.lang.String", "\"bar\"")
                .withMethodCall("append2", "java.lang.AbstractStringBuilder", "append()", 12, new ArrayList<>())
                .withOrderEdge("append1", "append2")
                .withParameterEdge("str2", "append2")
                .withReceiverEdge("sb", "append2")
                .withMethodCall("toStr", "java.lang.AbstractStringBuilder", "toString()", 13, new ArrayList<>())
